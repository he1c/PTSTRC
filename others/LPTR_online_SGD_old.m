function Xhat=LPTR_online_SGD_old(MissM,Mask,I,option)
            ...
            if ind_new(kk)~=0
                ...
                if n_p>=batch_start_size
                    ...
                    if ~isempty(Utr_TR{kk})
                        Utr_TR{kk} = TRSGD_scaled_add_acc(patch_miss, double(patch_miss~=-1), para_TR, Utr_TR{kk}, p_frame, p_frame*buffersize); 
                    else 
