function Xhat=OPTRC_individual(MissM,Mask,I,option)
    ...
    for i =1:length(patch_ind_s)        
       if patch_ind_s(i)~=0
           ...
           for s=1:1:interval^2
               tic
                [blk_patch_s,error_arr_s] = patch_BM_adjacent_frame_2(patchnew{s}, patchmasknew{s}, refpatch, refmask, total_patch_size_s, param, patch_ind_s(i)); 
                toc
