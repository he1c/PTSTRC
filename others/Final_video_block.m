...
Mask=imread('watermark_block.bmp');
Mask=imresize(Mask,0.4);
Mask=Mask(21:n_o(1)+20,61:n_o(2)+60,:);
Mask_f=uint8(imbinarize(Mask));
Mask=Mask_f;
for i=1:1:frame_num-1
    Mask=cat(4,Mask,Mask_f);
end
...
% time=[time toc];
% 
% save results\flower_0.05.mat

save results\video_bus_block.mat
