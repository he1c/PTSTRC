function [Xhat,time_all]=LPTR_mix_time(MissM,Mask,I,option)
...
for framenum=1+adjnum:5+adjnum
    ...
    parfor kk=1:size(blk_arr_n,2)
        ...
        if flag_TRNN(kk)
            ...
            Utr_TR = Completion_TR_norm(patch_miss, double(patch_miss~=-1), para_TR);
